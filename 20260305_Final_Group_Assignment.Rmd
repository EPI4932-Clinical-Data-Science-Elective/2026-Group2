...
ggsave(
  filename = file.path("outputs", "figures", "global_hdi_newcases_monthlymean_unweighted.png"),
  plot = p_final,
...
```{r cumulative-deaths-choropleth-map, echo=TRUE, message=FALSE, warning=FALSE, fig.width=11, fig.height=6, results='asis'}
# =========================================================
...
if (knitr::is_latex_output()) {
  ...
  webshot2::webshot(flat_tmp_html, flat_png, vwidth = 1400, vheight = 800)
...
if (knitr::is_latex_output()) {
  ...
  webshot2::webshot(globe_tmp_html, globe_png, vwidth = 1400, vheight = 800)
